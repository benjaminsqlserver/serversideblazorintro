...
namespace StudentRegApp.Pages
{
    public partial class EditStudentComponent : ComponentBase
    {
        ...
        {
            var conDataGetStudentByStudentIdResult = await ConData.GetStudentByStudentId(StudentID);
        ...
        protected async System.Threading.Tasks.Task Form0Submit(StudentRegApp.Models.ConData.Student args)
        {
            try
            {
                var conDataUpdateStudentResult = await ConData.UpdateStudent(StudentID, student);
